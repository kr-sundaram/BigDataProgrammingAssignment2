...
#######################################################################Randomly assign cards to between player and cpu
...
while game_started == False:
       ...
       while len(player_deck) > 0 and len(cpu_deck) > 0:
               ...
               if player_turn == True:
                       ...
                       print ("")
                       time.sleep(2)
               elif player_turn == False:  # CPU choses the characters to fight against whichever value is highest in its current card. 
               ...
               if current_battle_stat > cpu_current_battle_stat:
                       ...
                       cpu_deck.remove(cpu_current_card)
                       time.sleep(2)
               print ("CPU has", len(cpu_deck), "cards left! and scored",cpu_point,"points")
               print ("You have", len(player_deck), "cards left! and scored",player_point,"points")
               print ("There are", len(outdated_card), " outdated cards.")
               if current_battle_stat > cpu_current_battle_stat:
                       print ("")
                       print ("")
                       print ("##############")
